...
If any merge conflicts do arise, it is advised that you arrange a meeting or short video call to resolve conflicts with your collaborator (unless the conflicts are due to inconsequential differences such as comments or empty lines).
