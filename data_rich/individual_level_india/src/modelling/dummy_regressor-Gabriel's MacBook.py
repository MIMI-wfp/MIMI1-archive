...
iron_target = pd.read_csv("~/Documents/LSHTM/WFP_project/MIMI/datasets/ml_input_datasets/iron_target.csv") 
...
Y = zinc_target["inad_diff"]
X = zinc_target.drop(columns=["inad_diff"])
