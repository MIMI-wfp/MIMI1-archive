...
path_to_file <- "../MIMI_data/India/nsso_data/"
...
# bihar = 10, UP = 09, chat = 22, odisha = 21, mp = 23, jk = 20, wb = 19, , hp = 02 ap = 28, hy = 6, pj = 3, rj = 8
...
isolate_states <- function(block){
  ...
  block <- block %>%
    ...
    | State_code == "21"| State_code == "19" |State_code == "20" | State_code == "23" |
    State_code == "28" | State_code == "02"|
               State_code == "03"| State_code == "06" | State_code == "08" )
  return(block)
}
# 
...
path_to_save <- "data_rich/India/data/raw/"
