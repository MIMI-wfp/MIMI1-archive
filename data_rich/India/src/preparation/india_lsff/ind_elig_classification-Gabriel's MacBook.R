...
ind_expenditure <- read.csv("../data_science_code/DDI-IND-MOSPI-NSSO-68Rnd-Sch2.0-July2011-June2012/Summary of Consumer Expenditure - Block 12 - Level 11 - 68.csv")
...
exchange_usd_inr <- 78.6
wb_poverty_line_usd_day <- 2.15
poverty_line_inr <- wb_poverty_line_usd*exchange
